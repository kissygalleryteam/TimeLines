 ...
 * @module TimeLines
 **/
KISSY.add('gallery/TimeLines/1.0/index',function(S, Node, Base, Anim) {
  ...
  function TimeLines(config) {
    var self = this;
    TimeLines.superclass.constructor.call(self, config);
    self.init();
  }
  S.extend(TimeLines, S.Base);
  S.augment(TimeLines, {
    /**
     * 初始化
